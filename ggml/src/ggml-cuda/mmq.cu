...
void ggml_cuda_mul_mat_q(
    ...
    const char * gcn_w4a4_full_range_env = getenv("GGML_CUDA_GCN_W4A4_FULL_RANGE");
    const bool gcn_w4a4_full_range = gcn_w4a4_full_range_env && atoi(gcn_w4a4_full_range_env) != 0;
    const char * gcn_w4a4_scale16_env = getenv("GGML_CUDA_GCN_W4A4_SCALE16");
    const bool gcn_w4a4_scale16 = gcn_w4a4_scale16_env && atoi(gcn_w4a4_scale16_env) != 0;
    const char * gcn_w4a4_scale8_env = getenv("GGML_CUDA_GCN_W4A4_SCALE8");
    const bool gcn_w4a4_scale8 = gcn_w4a4_scale8_env && atoi(gcn_w4a4_scale8_env) != 0;
    const char * gcn_w4a4_scale8_fp32_env = getenv("GGML_CUDA_GCN_W4A4_SCALE8_FP32");
    const bool gcn_w4a4_scale8_fp32 = gcn_w4a4_scale8_fp32_env && atoi(gcn_w4a4_scale8_fp32_env) != 0;
    const char * gcn_w4a4_mse_scale_env = getenv("GGML_CUDA_GCN_W4A4_MSE_SCALE");
    ...
    const char * gcn_w4a4_residual_div_env = getenv("GGML_CUDA_GCN_W4A4_RESIDUAL_DIV");
    const float gcn_w4a4_residual_div = gcn_w4a4_residual_div_env ? atof(gcn_w4a4_residual_div_env) : 16.0f;
    GGML_ASSERT(gcn_w4a4_amax_scale > 0.0f);
    GGML_ASSERT(gcn_w4a4_residual_div > 0.0f);
    ...
    if (!ids) {
...

        {
            ...
            if (use_native_fp4) {
                ...
                quantize_mmq_q4_0_cuda(src1_d, nullptr, src1_q8_1.get(), src0->type, ne10, s11, s12, s13, ne10_padded,
                                       ne11, ne12, ne13, gcn_w4a4_amax_scale, gcn_w4a4_full_range, gcn_w4a4_scale16, gcn_w4a4_scale8, gcn_w4a4_scale8_fp32, gcn_w4a4_mse_scale, gcn_w4a4_residual, gcn_w4a4_residual_mse, gcn_w4a4_residual_div, stream);
            } else {
        ...
        const mmq_args args = {
            ...
            use_gcn_w4a4, gcn_w4a4_scale16, gcn_w4a4_scale8, gcn_w4a4_scale8_fp32, gcn_w4a4_residual, gcn_w4a4_residual_div,
    ...
    const mmq_args args = {
        ...
        src1_scale.ptr,
        false, false, false, false, false, 16.0f,
