...
void ggml_cuda_mul_mat_q(
    ...
    GGML_ASSERT(!gcn_w4a4_residual || gcn_w4a4_full_range);
    ...
    if (!ids) {
...

        {
            ...
            if (use_native_fp4) {
                ...
                quantize_mmq_q4_0_cuda(src1_d, nullptr, src1_q8_1.get(), src0->type, ne10, s11, s12, s13, ne10_padded,
                                       ne11, ne12, ne13, gcn_w4a4_amax_scale, gcn_w4a4_full_range, false, false, false, false, gcn_w4a4_residual, stream);
            } else {
        ...
        const mmq_args args = {
            ...
            use_gcn_w4a4, gcn_w4a4_residual,
