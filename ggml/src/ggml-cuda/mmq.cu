...
void ggml_cuda_mul_mat_q(
    ...
    GGML_ASSERT(!gcn_w4a4_residual || (gcn_w4a4_full_range && !gcn_w4a4_scale16 && !gcn_w4a4_scale8));
    ...
    if (!ids) {
        ...
        const mmq_args args = {
            ...
            use_gcn_w4a4, gcn_w4a4_scale16, gcn_w4a4_scale8, gcn_w4a4_scale8_fp32, gcn_w4a4_residual,
